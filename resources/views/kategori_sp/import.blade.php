                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h6>Jenis Pelanggaran yang terdaftar</h6>
                        ...
                        <div class="card-body">
                            <form action="{{ route('kategori-sp.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <a href="{{ route('kategori-sp.index') }}" class="btn btn-light">⬅️ Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
